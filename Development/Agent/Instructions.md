...
Working notes for AI agents and developers touching Orion SCP RP.
...
`Compile of 'orionnetworks.scp_rp_1' Failed` and `Error |`. Fix every error and re-read the log before
