# Orion SCP RP Developer README

Team-facing hub for understanding the Orion SCP RP project layout, gameplay loop, and where each
...
- Game title: `Orion SCP RP`
- Author: `Orion Networks`
- Project file: `scp_rp_1.sbproj`
- Package ident: `orionnetworks.scp_rp_1`
- Startup scene: `scp_rp_scene_1.scene`
